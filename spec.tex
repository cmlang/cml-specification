...
\lstdefinelanguage{cml}
{
  ...
  morekeywords={,concept,task,association,select,reject,
...
\lstdefinelanguage{ocl_}
{
  ...
  morecomment=[l]{//},
  commentstyle = \color{black},
  morekeywords={,context,inv,pre,post,and,or,implies,derive,body,}]
}
...
\input{expressions/expressions.tex}
