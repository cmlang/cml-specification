...
\part{Expressions}
  ...
  \input{definitions/arithmetic.tex}
    ...
    \section{Constraints}
    \input{constraints/arithmetic.tex}
  ...
  \input{definitions/logical-expr.tex}
    ...
    \section{Constraints}
    \input{constraints/logical-expr.tex}
  ...
  \input{definitions/relational-expr.tex}
    ...
    \section{Constraints}
    \input{constraints/relational-expr.tex}
  ...
  \input{definitions/referential-expr.tex}
    ...
    \section{Constraints}
    \input{constraints/referential-expr.tex}
  ...
  \input{definitions/conditional-expr.tex}
    ...
    \section{Constraints}
    \input{constraints/conditional-expr.tex}
  ...
  \input{definitions/string-concatenation.tex}
    ...
    \section{Constraints}
    \input{constraints/str-concat.tex}
