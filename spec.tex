...
\part{Type System}
  ...
  \label{ch:referential-types}
  \input{definitions/referential-types.tex}

  \chapter{Required Types}
  \label{ch:required-types}
  \input{definitions/required-types.tex}

  \chapter{Optional Types}
  \label{ch:optional-types}
  \input{definitions/optional-types.tex}

  \chapter{Sequential Types}
  \label{ch:sequential-types}
  \input{definitions/sequential-types.tex}

  \chapter{Tuple Types}
  \label{ch:tuple-types}

  \chapter{Concept Types}
