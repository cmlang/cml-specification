...
There are two unidirecional associations in the \emph{Concept} class
that keep track of generalization/specialization relationships:
...
\item \emph{allAncestors}:
a derived property,
defined in the figure \ref{fig:meta:allAncestors},
referencing all \emph{concepts} whose NAMEs were enumerated in the \emph{AncestorList}
of the declared \emph{concept} and of all its \emph{directAncestors}.

\end{itemize}
\end{abstract-syntax}

\begin{figure}
\lstinputlisting[language=ocl_]{ocl/allAncestors.ocl}
\caption{Definition of Concept::allAncestors}
\label{fig:meta:allAncestors}
\end{figure}
