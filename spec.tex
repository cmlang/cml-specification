...
\part{Conceptual Modeling}
  ...
  \chapter{Functions}
      ...
      \section{Comprehension Functions}
...
\part{Expressions}
  ...
  \input{definitions/expressions.tex}
    ...
    \section{Metamodel}
    \input{metamodel/expressions.tex}

    \section{Model Synthesis}
    \input{synthesis/expressions.tex}
  ...
  \input{definitions/arithmetic.tex}
    ...
    \section{Metamodel}
    \input{metamodel/arithmetic.tex}
  ...
  \input{definitions/logical-expr.tex}
    ...
    \section{Metamodel}
    \input{metamodel/logical-expr.tex}
  ...
  \input{definitions/relational-expr.tex}
    ...
    \section{Metamodel}
    \input{metamodel/relational-expr.tex}
  ...
  \input{definitions/referential-expr.tex}
    ...
    \section{Metamodel}
    \input{metamodel/referential-expr.tex}
  ...
  \input{definitions/str-concat.tex}
    ...
    \section{Metamodel}
    \input{metamodel/str-concat.tex}
  ...
  \input{definitions/comprehensions.tex}
    ...
    \section{Syntax}
    \input{syntax/comprehensions.tex}
